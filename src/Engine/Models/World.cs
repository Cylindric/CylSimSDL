...
namespace Engine.Models
{
    internal class World
    {
        ...
        public static World Instance { get { return _instance.Value; } }
        ...
        public void Generate(int width, int height)
        {
            ...
            Log.Instance.Debug("World (" + this.Width + "," + this.Height + ") created with " + (this.Width * this.Height) + " tiles.");
        ...
        public Character CreateCharacter(Tile t)
        {
            ...
            this._cbCharacterCreated?.Invoke(c);
